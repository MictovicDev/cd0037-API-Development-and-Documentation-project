...
class TriviaTestCase(unittest.TestCase):
    ...
    database_pass = os.environ.get('DB_PASSWORD')
    database_host = os.environ.get('LOCAL_HOST')
    ...
    def setUp(self):
        ...
        self.database_path = "postgres://{}:{}@{}/{}".format(
            database_user, database_pass, database_host, self.database_name)
    ...
    def test_get_search_question_without_result(self):
    ...
    def test_delete_questions(self):
        ...
        question = Question.query.filter(Question.id == 80).one_or_none()

        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['success'], True)
        self.assertEquals(data['deleted'], 80)
    ...
    def test_play_quiz_with_invalid_quiz_category(self):
        input_data = {
            'previous_questions': [4, 6],
            'quiz_category': {
                'id': 9,
